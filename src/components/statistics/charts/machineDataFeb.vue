            ...
            <va-card>
              <div class="row row-separated">
                ...
                <div class="flex xs3">
                  ...
                  >{{ machine.hours }}</p>
                  <p class="text--center display-5 mb-1">Hrs.</p>
                </div>
                <div
                  class="flex xs3"
    ...
    <div class="row">
      <div class="flex md6 xs12 lg6">
        <va-card id="pad-0">
          <template slot="header">
            <va-icon name="fa fa-2x fa-plug mr-3" color="danger" />
            <p class="mt-0 mb-0 display-1 text-center">Full Load Demand [ KVA ]</p>
          </template>
          <div class="flex xs12 md12">
            <va-card>
              <div class="row row-separated">
                <div class="flex xs2">
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.KVA}">10</p>
                  <p class="text--center display-5 mb-1">Machine 1</p>
                </div>
                <div class="flex xs2">
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.KW}">12.5</p>
                ...
                <div class="flex xs2">
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.Kwh}">10</p>
                ...
                <div
                  ...
                  :style="{ backgroundColor: machineDataColors.hours, borderRadius: '5px',  }"
                >
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.Kwh}">64</p>
      ...
      <div class="flex md6 xs12 lg6">
        <va-card id="pad-0">
          <template slot="header">
            <va-icon name="fa fa-2x fa-plug mr-3" color="danger" />
            <p class="mt-0 mb-0 display-1 text-center">Full Load Demand [ KW ]</p>
          </template>
          <div class="flex xs12 md12">
            <va-card>
              <div class="row row-separated">
                <div class="flex xs2">
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.KVA}">8</p>
                  <p class="text--center display-5 mb-1">Machine 1</p>
                </div>
                <div class="flex xs2">
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.KW}">10</p>
                  <p class="text--center display-5 no-wrap mb-1">Machine 2</p>
                </div>
                <div class="flex xs2">
                  <p
                ...
                <div class="flex xs2">
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.Kwh}">8</p>
                  <p class="text--center display-5 mb-1">Machine 4</p>
                </div>
                <div
                  class="flex xs4"
                  :style="{ backgroundColor: machineDataColors.hours, borderRadius: '5px',  }"
                >
                  <p class="display-2 mb-1 text--center" :style="{color: machineDataColors.Kwh}">51</p>
                  <p class="text--center display-5 mb-1">Total</p>
                </div>
              </div>
            </va-card>
